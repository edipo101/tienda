    ...
    <nav aria-label="breadcrumb" class="breadcrumb-nav mb-2">
        <div class="container">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">{{title_case($category)}}</li>
            </ol>
        </div>
    </nav>
@endsection
...
@section('content')
    ...
    <div class="page-content">
        <div class="container">
            <h2 class="title text-center mb-3">{{$category}}</h2>
            <div class="toolbox">
                    ...
                    <div class="col-6 col-md-4 col-lg-4 col-xl-2">
                        <div class="product">
                            ...
                            <div class="product-body">
                                ...
                                <h3 class="product-title"><a href="{{route('animes.details', $product->slug)}}">{{$product->name}}</a></h3>
