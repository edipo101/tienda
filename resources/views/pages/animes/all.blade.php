...
@section('content')
    ...
    <div class="page-content">
        <div class="container">
            <h2 class="title text-center mb-3">Todos los animes</h2>
            <div class="toolbox">
                ...
                <div class="toolbox-center">
                    <div class="toolbox-info">
                        Mostrando <span>{{$products->count()}} de {{$products->total()}}</span> Animes
                    </div>
                    ...
                    <div class="col-6 col-md-4 col-lg-4 col-xl-2">
                        <div class="product">
                            <figure class="product-media">
                                ...
                                @endif
                                <a href="{{route('animes.details', $product->slug)}}">
                            ...
                            <div class="product-body">
                                <div class="product-cat">
                                    <a href="{{route('animes.by_category', $product->categ_slug)}}">{{$product->categ_name}}</a>
                                </div><!-- End .product-cat -->
                                <h3 class="product-title"><a href="{{route('animes.details', $product->slug)}}">{{title_case($product->name)}}</a></h3>
