...
@section('content')
    ...
    <div class="page-content">
        <div class="container">
            <h2 class="title text-center mb-3">Resultados búsqueda</h2>
            <div class="toolbox">
                ...
                <div class="toolbox-center">
                    <div class="toolbox-info">
                        Mostrando <span>{{$products->count()}} de {{$products->total()}}</span> registros
                    </div>
                    ...
                    <div class="col-6 col-md-4 col-lg-4 col-xl-2">
                        <div class="product">
                            ...
                            <div class="product-body">
                                ...
                                <h3 class="product-title"><a href="{{route('animes.details', $product->slug)}}">{{$product->name}}</a></h3><!-- End .product-title -->
